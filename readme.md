...
- To our knowledge, ACA is the first method to enable Neural-ODE model to outperform a standard ResNet model on benchmark such as Cifar classification, which also supports adaptive-stepsize and error estimation as most widely used softwares. <br/>
