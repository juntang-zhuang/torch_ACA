...
class RK23(AdaptiveGridSolver):
    ...
    def step(self, func, t, dt, y, return_variables=False):
        ...
        out2 = y + 7. / 24. * k1 + 1. / 4. * k2 + 1. / 3. * k3 + 1. / 8. * k4
        error = out1 - out2

        if return_variables:
            return out1, error, [k1, k2, k3, k4, out2]
        else:
            return out1, error
...
class Dopri5(AdaptiveGridSolver):
    ...
    def step(self, func, t, dt, y, return_variables=False):
        ...
        out2 = y + 5179. / 57600. * k1 + 0 * k2 + 7571. / 16695. * k3 + 393. / 640. * k4 - 92097. / 339200. * k5 + 187. / 2100. * k6 + 1. / 40. * k7
        error = out1 - out2

        if return_variables:
            return out1, error, [k1, k2, k3, k4, k5, k6, k7, out2]
        else:
            return out1, error
